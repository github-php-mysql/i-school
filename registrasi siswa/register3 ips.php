...
<?php
				if(isset($_POST['Registrasi'])){
							...
							$sql = "UPDATE data_siswa_ips SET nama_ayah='".$nama_ayah."', nama_ibu='".$nama_ibu."', nik='".$nik."', pekerjaan_ibu='".$pekerjaan_ibu."', pekerjaan_ayah='".$pekerjaan_ayah."', agama_orangtua='".$agama."', no_orangtua='".$tlp."', alamat_orangtua='".$alamat."' where id_user='".$id_user."'";
