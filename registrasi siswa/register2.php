...
<?php
				if(isset($_POST['Registrasi'])){
							...
							$sql = "UPDATE data_siswa_ipa SET nama_lengkap='".$nama."', agama='".$agama."', no_telepon='".$tlp."', alamat='".$alamat."' where id_user='".$id_user."'";
							if (mysqli_query($conn, $sql)) 
						{
								echo "<script>alert('Data di simpan');document.location='register3.php'</script>";
						} else{
