...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"><img src="logo/login.png" width="100%" height="auto">
    <center>
            <div class="box-header">
			<h3>Pilih Login : </h3>
             </div>
	<form method="post">    
              <a href="index ipa.php" class="btn btn-app bg-blue">
                <i class="fa fa-user"></i> IPA
              </a>
              <a href="index ips.php"class="btn btn-app bg-green">
                <i class="fa fa-user"></i> IPS
              </a>
