...
<?php
				if(isset($_POST['Registrasi'])){
							...
							$sql = "UPDATE data_siswa_ips SET nama='".$nama."', jenis_kelamin='".$jenis_kelamin."', tanggal_lahir='".$tgl_lahir."', password='".$password."', email='".$email."' where id_user='".$id_user."'";
							if (mysqli_query($conn, $sql)) 
						{
								echo "<script>alert('Data di simpan');document.location='register2 ips.php'</script>";
						} else{
