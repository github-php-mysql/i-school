                                    ...
                                    <thead> 
                                        ...
                                        <?php do { ?>
                                          <tr>
                                            ...
                                            <td><?php echo $row_Recordset1['nama_ayah']; ?></td>
                                            <td><?php echo $row_Recordset1['pekerjaan_ayah']; ?></td>
                                            <td><?php echo $row_Recordset1['nama_ibu']; ?></td>
                                            <td><?php echo $row_Recordset1['pekerjaan_ibu']; ?></td>
