...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE siswa SET nama=%s, tempat_lahir=%s, tanggal_lahir=%s, alamat=%s, sekolah_asal=%s, jenis_kelamin=%s, agama=%s, hp=%s, kode_keluarga=%s, kode_kelas=%s, kode_sikap=%s, kode_ekstra=%s WHERE nis=%s",
...
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset1 = sprintf("SELECT * FROM siswa WHERE nis = '$colname_Recordset1' ");
                                ...
                                <div class="col-lg-6">
                                    <form action="<?php echo $editFormAction; ?>" method="POST" name="form" role="form">
                                         ...
                                         <tr>
                                            ...
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="nis" name="nis" value="<?php echo $row_Recordset1['nis']; ?> " readonly/></td>
                                            <td width="20"></td>
                                            <td width="100"><label>Kode Keluarga</label></td>
                                            <td width="10">  :</td>
											<td width="300"><input type="text" class="form-control" id="kode_keluarga" name="kode_keluarga" value="<?php echo $row_Recordset1['kode_keluarga']; ?>" /></td>
                                          ...
                                          <tr>
                                            ...
                                            <td width="10">  :</td>
											<td width="300"><input type="text" class="form-control" id="kode_ekstra" name="kode_ekstra" value="<?php echo $row_Recordset1['kode_ekstra']; ?>" /></td>
                                         </tr>
                                          <tr>
                                            <td width="100"><label>Tempat Lahir</label></td>
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?php echo $row_Recordset1['tempat_lahir']; ?>" /></td>
                                            <td width="20"></td>
                                            <td width="100"><label>Kode Sikap</label></td>
                                            <td width="10">  :</td>
											<td width="300"><input type="text" class="form-control" id="kode_sikap" name="kode_sikap" value="<?php echo $row_Recordset1['kode_sikap']; ?>" /></td>
                                         </tr>
                                          <tr>
                                            <td width="100"><label>Tanggal Lahir</label></td>
                                            <td width="10">  :  </td>
											<td width="300"><input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo $row_Recordset1['tanggal_lahir']; ?>" /></td>
                                            <td width="20"></td>
                                            <td width="100"><label>Kode Kelas</label></td>
                                            <td width="10">  :</td>
											<td width="300"><input type="text" class="form-control" id="kode_kelas" name="kode_kelas" value="<?php echo $row_Recordset1['kode_kelas']; ?>" /></td>
                                         </tr>
                                           <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="sekolah_asal" name="sekolah_asal" value="<?php echo $row_Recordset1['sekolah_asal']; ?>" /></td>
                                         </tr>
                                           <tr>
                                            <td width="100"><label>Agama</label></td>
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="agama" name="agama" value="<?php echo $row_Recordset1['agama']; ?>" /></td>
                                         </tr>
                                           <tr>
