...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE mapel SET nama_mapel=%s, kode_guru=%s WHERE kode_mapel=%s",
...
if (isset($_GET['kode_mapel'])) {
  $colname_Recordset1 = $_GET['kode_mapel'];
}
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset1 = sprintf("SELECT * FROM mapel WHERE kode_mapel = %s", GetSQLValueString($colname_Recordset1, "text"));
                ...
                <div class="col-md-12 col-sm-4">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            Form Update Data Mata Pelajaran
                        </div>
                             ...
                             <form action="<?php echo $editFormAction; ?>" method="POST" name="form" role="form">
                   			   <div class="form-group">
                                         ...
                                         <tr>
                                            ...
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="kode_mapel" name="kode_mapel" value="<?php echo $row_Recordset1['kode_mapel']; ?> " readonly/></td>
                                            <td width="20"></td>
                                          ...
                                          <tr>
                                            ...
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="nama_mapel" name="nama_mapel" value="<?php echo $row_Recordset1['nama_mapel']; ?> " /></td>
                                            <td width="20"></td>
                                           
                                         </tr>
                                          <tr>
                                            <td width="200"><label>Kode Guru Pengampu</label></td>
                                            <td width="10">  :  </td>
											<td width="300">
                                             <select class="form-control" id="kode_guru" name="kode_guru">
											    <?php
													do {  
												?>
											    <option value="<?php echo $row_Recordset2['kode_guru']?>"<?php if (!(strcmp(					$row_Recordset2['kode_guru'], $row_Recordset2['kode_guru']))) {echo "selected=\"selected\"";} ?>><?php echo $row_Recordset2['kode_guru']?></option>
											    <?php
