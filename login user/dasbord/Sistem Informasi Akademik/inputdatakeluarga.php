...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO keluarga (kode_keluarga, nama_ayah, pekerjaan_ayah, nama_ibu, pekerjaan_ibu, alamat, no_telp) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "inputdatakeluarga.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset1 = "SELECT * FROM keluarga ORDER BY kode_keluarga ASC";
                ...
                <div class="col-md-12 col-sm-4">
                   ...
                   <form method="POST" action="<?php echo $editFormAction; ?>" name="form" role="form">
                                         ...
                                         <tr>
                                            ...
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="kode_keluarga" name="kode_keluarga"></td>
                                         </tr>
                                          <tr>
                                            <td width="100"><label>Nama Ayah</label></td>
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="nama_ayah" name="nama_ayah"></td>
                                         </tr>
                                          <tr>
                                            <td width="100"><label>Pekerjaan Ayah</label></td>
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah"></td>
                                         </tr>
                                          <tr>
                                            <td width="100"><label>Nama Ibu</label></td>
                                            <td width="10">  :</td>
											<td width="200"><input type="text" class="form-control" id="nama_ibu" name="nama_ibu"></td>
                                         </tr>
                                           <tr>
                                            <td width="100"><label>Pekerjaan Ibu </label></td>
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu"></td>
                                         </tr>
                                     
                                         <tr>
                                            <td width="100"><label>Alamat</label></td>
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="alamat" name="alamat"></td>
                                         </tr>
                                           <tr>
                                            <td width="100"><label>No Telepon</label></td>
                                            <td width="10">  :  </td>
											<td width="200"><input type="text" class="form-control" id="no_telp" name="no_telp"></td>
                                           </tr><tr>
                                         <td width="100" ></td>
                                            <td width="10"></td>
											<td width="200">  
