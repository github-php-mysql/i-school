...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form")) {
  $insertSQL = sprintf("INSERT INTO kelas (kode_kelas, nama_kelas, kode_guru) VALUES (%s, %s, %s)",
...
mysql_select_db($database_koneksi, $koneksi);
$query_Recordset1 = "SELECT * FROM kelas ORDER BY kode_kelas ASC";
                        	...
                        	<div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" action="<?php echo $editFormAction; ?>" name="form" role="form">
                                         ...
                                         <tr>
                                            <td width="200"><label>Kode Kelas</label></td>
                                            <td width="10">  :  </td>
                                          ...
                                          <tr>
                                            <td width="200"><label>Nama Kelas</label></td>
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="nama_kelas" name="nama_kelas"></td>
                                            <td width="20"></td>
                                           
                                         </tr>
                                          <tr>
                                            <td width="200"><label>Kode Wali Kelas</label></td>
                                            <td width="10">  :  </td>
											<td width="300"><input type="text" class="form-control" id="wali_kelas" name="wali_kelas"></td>
                                            <td width="20"></td>
