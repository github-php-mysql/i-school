...
$query_Recordset1 = "SELECT * FROM siswa ORDER BY nis ASC";
                                ...
                                <thead>
                                  ...
                                  <?php do { ?>
                                    <tr>
                                      ...
                                      <td><?php echo $row_Recordset1['tempat_lahir']; ?></td>
                                      <td><?php echo $row_Recordset1['tanggal_lahir']; ?></td>
                                      <td><?php echo $row_Recordset1['alamat']; ?></td>
                                      <td><?php echo $row_Recordset1['sekolah_asal']; ?></td>
                                      <td><?php echo $row_Recordset1['jenis_kelamin']; ?></td>
                                      <td><?php echo $row_Recordset1['agama']; ?></td>
                                      <td><?php echo $row_Recordset1['hp']; ?></td>
                                      <td><?php echo $row_Recordset1['kode_keluarga']; ?></td>
                                      <td><?php echo $row_Recordset1['kode_kelas']; ?></td>
                                      <td><?php echo $row_Recordset1['kode_sikap']; ?></td>
                                      <td><?php echo $row_Recordset1['kode_ekstra']; ?></td>
                                    </tr>
