...
<head>
  ...
  <title>Input Nilai Harian</title>
 ...
 <aside class="main-sidebar">
      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="nilai harian.php"><i class="fa fa-circle-o"></i> Nilai Ulangan Harian</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
		<h2>Nilai Ulangan Harian IPA</h2>
    </section>
...
?>
		...
		<center><td><?php echo $no; ?></td></center>
          ...
          <td><input type="submit" name="simpan" value="Tambah" class="btn btn-primary">
          </td>
          </form>
		</tr>
