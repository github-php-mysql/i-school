...
if (empty($cari)) {
	$nisbaru = $_GET['nis'];
  $qry = mysqli_query($conn, "SELECT * from pembayaran_ipa where nis = '$nisbaru'");
} else {
  $qry = mysqli_query($conn, "SELECT * from pembayaran_ipa where nama like '%".$cari."%'");
}
...
<?php
	if(isset($_POST['simpan'])){
		...
		$query = "update pembayaran_ipa set pembayaran = '$pembayaran', tanggal = '$tanggal' where nis = '$nis'";
