      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
					<?php
								...
								if (empty($cari)) {
									$qry = mysqli_query($conn, "SELECT * from pembayaran_ipa ");
								}
								else {
		...
		<td>
          ...
          <td><a href="edit pembayaran.php?nis=<?php echo $data['nis']; ?>"><span data-toggle="tooltip" title="Edit Pembayaran"><button class="btn btn-warning">
