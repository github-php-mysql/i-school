...
<?php
  require_once('../../koneksi.php');
	if(isset($_POST['simpan'])){
		...
		$qry = "insert into daftar_hadir_ipa values ('','','$nis','','','$kehadiran')";
		unset($_POST['simpan']);
	}
?>
<html>
...
if (empty($cari)) {
  $qry = mysqli_query($conn, "SELECT * from kehadiran_ipa ");
} else {
  $qry = mysqli_query($conn, "SELECT * from kehadiran_ipa where nama like '%".$cari."%'");
}
