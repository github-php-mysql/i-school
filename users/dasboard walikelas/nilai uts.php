...
<?php
  require_once('../../koneksi.php');
	if(isset($_POST['simpan'])){
		...
		$nis = $_POST['nis'];
		$mapel = $_POST['mapel'];
		$result = mysqli_query($conn, "SELECT * FROM nilai_ipa WHERE nis='$nis'");
		$num_rows = mysqli_num_rows($result);
		//echo $num_rows;
		//die();
		if($num_rows>0){
			$qry = "update nilai_ipa set nis='$nis', kode_mapel='$mapel', uts='$nilai' WHERE nis='$nis'";
			//echo $qry;
			//die();
		}else {
      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="nilai uts.php"><i class="fa fa-circle-o"></i> Nilai UTS</a></li>    
