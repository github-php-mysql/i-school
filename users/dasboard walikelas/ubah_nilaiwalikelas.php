...
<?php
  require_once('../../koneksi.php');
	if(isset($_POST['simpan'])){
		...
		$nis = $_POST['nis'];
		$mapel = $_POST['mapel'];
		$qry = "update nilai_ipa set uts = '$uts', harian = '$nilai', nilai_semester = '$smt' where nis = '$nis'";
...
$mapelTabel.="</select>";
if (empty($cari)) {
  $qry = mysqli_query($conn, "SELECT * from data_siswa_ipa,nilai_ipa where nilai_ipa.nis = data_siswa_ipa.nis");
} else {
  $qry = mysqli_query($conn, "SELECT * from data_siswa_ipa,nilai_ipa where nilai_ipa.nis = data_siswa_ipa.nis AND data_siswa_ipa.nis = '$cari'");
}
