      ...
      <ul class="sidebar-menu"><li class="active treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			<li class="active"><a href="data nilai.php"><i class="fa fa-circle-o"></i> Laporan Data Nilai</a></li>
			<li><a href="data absensi.php"><i class="fa fa-circle-o"></i> Laporan Data Absensi</a></li>
			...
			<div class="box-body no-padding">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
					<?php
						$qry1 = mysqli_query ($conn,"select harian from nilai_ips where nis = '$nis'");
                  ...
                  <td><?php
						$qry2 = mysqli_query ($conn,"select uts from nilai_ips where nis = '$nis'");
						if ($data2 = mysqli_fetch_array($qry2)){
							echo $data2['uts'];
						}
					?>
				</td>
				  <td><?php
						$qry3 = mysqli_query ($conn,"select nilai_semester from nilai_ips where nis = '$nis'");
						if ($data3 = mysqli_fetch_array($qry3)){
							echo $data3['nilai_semester'];
						}
					?>
				</td>
                </tr>
