...
<?php
	...
	$nis = $_SESSION['nis'];
	$qry = mysqli_query ($conn, "select * from data_siswa_ips where nis = '$nis'");
      ...
      <ul class="sidebar-menu"><li class="treeview active">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="data absensi.php"><i class="fa fa-circle-o"></i> Laporan Daftar Hadir</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="alert alert-dismissable alert-warning" id="pulsate1">
			...
			<i class="fa fa-exclamation-circle"/></i> edit profil, dit, klik tab pada data profile, masukan text/angka pada kolom yang ingin di edit lalu klik simpan.<p>
			untuk mengubh foto anda silahkan klik <i>chosee</i> untuk pilih foto dan klik ganti foto untuk menyimpan.
		</div>
	  
         <div class="col-md-3">
		 <form method="post" enctype="multipsrt/form-data">
                ...
                $path = "photos/".$nama_file_baru;
                    ...
                    if($tipe_file == "image/jpeg" || $tipe_file == "image/png")
                    {
                        if($ukuran_file <= 2000000)
                        {
                            ...
                            $sql = "update data_siswa_ips set foto='".$nama_file_baru."' where nis='".$nis."'";
		...
		<div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Data Sekolah</a></li>
              ...
              <div class="active tab-pane" id="activity">
				...
				<form class="form-horizontal" action="" method="post">
				  ...
				  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kelas" value="<?php echo $data['semester']; ?>" readonly>
                    </div>
                  </div>
				  <div class="form-group">
				...
				if(isset($_POST['simpan1'])){
						...
						$kelas = $_POST['kelas'];
							if(!empty($kelas))
					{
							$sql = "UPDATE data_siswa_ips SET kelas='".$kelas."' where nis='".$nis."'";
							if (mysqli_query($conn, $sql)) 
						{
			...
			<?php
				if(isset($_POST['simpan2'])){
					...
					{
							$sql = "UPDATE data_siswa_ips SET password='".$pass."', nama='".$nama."', email='".$email."' where nis='".$nis."'";
							if (mysqli_query($conn, $sql)) 
						{
								echo"<span class='badge bg-green'><span class='fa fa-check-circle'></span>  berhasil di simpan </span>";
						} else{
              ...
              <div class="tab-pane" id="settings">
				...
				if(isset($_POST['simpan3'])){
						...
						$telepon = $_POST['telepon'];
							if(!empty($nama_lengkap) && !empty($tanggal_lahir) && !empty($agama) && !empty($asl_skolah) && !empty($alamat) && !empty($telepon))
					{
							$sql = "UPDATE data_siswa_ips SET nama_lengkap='".$nama_lengkap."', tanggal_lahir='".$tanggal_lahir."', agama='".$agama."', asal_sekolah='".$asl_skolah."', alamat='".$alamat."', no_telepon='".$telepon."' where nis='".$nis."'";
							if (mysqli_query($conn, $sql)) 
						{
								echo"<span class='badge bg-green'><span class='fa fa-check-circle'></span>  berhasil di simpan </span>";
						} else{
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<h4>Form Input Data Siswa ips</h4>
