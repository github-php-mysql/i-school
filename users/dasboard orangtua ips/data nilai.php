      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="data nilai.php"><i class="fa fa-circle-o"></i>Nilai Siswa</a></li>
			...
			<div class="box-body no-padding">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php
						$qry2 = mysqli_query ($conn,"select uts from nilai_ipa where nis = '$nis'");
				  ...
				  <td><?php
						$qry3 = mysqli_query ($conn,"select nilai_semester from nilai_ipa where nis = '$nis'");
