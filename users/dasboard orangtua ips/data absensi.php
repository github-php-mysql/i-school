      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="data absensi.php"><i class="fa fa-circle-o"></i>Daftar Hadir Siswa</a></li>
      ...
      <div class="row">
			...
			<div class="box-body table-responsive no-padding">
			  ...
			  <?php
					...
					$nis = $_SESSION['nis'];
					$qry = mysqli_query ($conn, "select * from kehadiran_ips where nis = '$nis'");
					$no = 1;
                ...
                <tr>
				  ...
				  <td><?php
						$qry1 = mysqli_query ($conn,"select tanggal from kehadiran_ips where nis = '$nis'");
				  ...
				  <td><?php
						$qry1 = mysqli_query ($conn,"select kehadiran from kehadiran_ips where nis = '$nis'");
						if ($data1 = mysqli_fetch_array($qry1)){
