        ...
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"><?php echo"<b>".$_SESSION['nip']."</b>"; ?></span>
            </a>
      ...
      <ul class="sidebar-menu"><li class="active treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="dasboard walikelas/nilai harian.php"><i class="fa fa-circle-o"></i> Nilai Ulangan Harian</a></li>
			<li><a href="dasboard walikelas/nilai uts.php"><i class="fa fa-circle-o"></i> Nilai UTS</a></li>    
			<li><a href="dasboard walikelas/nilai semester.php"><i class="fa fa-circle-o"></i> Nilai Semester</a></li>			
    ...
    <section class="content">
	  ...
	  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="data siswa guru/data siswa.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="data siswa guru/data absensi.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="data siswa guru/data nilai.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="data siswa guru/data pembayaran.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
