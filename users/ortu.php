        ...
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs"><?php echo $data['nama_ayah'];?></span>
            </a>
...
<aside class="main-sidebar">
      ...
      <ul class="sidebar-menu"><li class="active treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="dasboard orangtua/data nilai.php"><i class="fa fa-circle-o"></i>Nilai Siswa</a></li>
			<li><a href="dasboard orangtua/data absensi.php"><i class="fa fa-circle-o"></i>Daftar Hadir Siswa</a></li>
			<li><a href="dasboard orangtua/data pembayaran.php"><i class="fa fa-circle-o"></i>Pembayaran Siswa</a></li>
		  </ul>
        </li>
		<li class="treeview">
          <a href="dasboard orangtua/perwalian.php">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <h1>Dashboard Orang Tua</h1><br>
		<div class="callout callout-info">
       <b>Unit Informasi Akademik</b> <p>Adalah suatu System yang di bangun untuk mengelola data-data akademik sehingga memberikan kemudahan kepada pengguna dalam kegiatan akademik sekolah secara online</p>
        </div>
    </section>
    ...
    <section class="content">
	  ...
	  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="dasboard orangtua/data nilai.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <p></p><br>
              <p><b>Daftar Hadir</b></p><br>
			  <p></p>
            </div>
            <div class="icon">
              <i class="fa fa-fw fa-table"></i>
            </div>
            <a href="dasboard orangtua/data absensi.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <p></p><br>
              <p><b>Pembayaran</b></p><br>
			  <p></p>
            </div>
            <div class="icon">
              <i class="fa fa-fw fa-bar-chart"></i>
            </div>
            <a href="dasboard orangtua/data pembayaran.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <p></p><br>
              <p><b>Perwalian</b></p><br>
			  <p></p>
            </div>
            <div class="icon">
              <i class="fa fa-fw fa-users"></i>
            </div>
            <a href="dasboard orangtua/perwalian.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
