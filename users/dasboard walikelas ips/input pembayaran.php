        ...
        <li class="treeview">
		 ...
		 <li class="treeview active">
          ...
          <ul class="treeview-menu">
			...
			<li  class="active"><a href="input pembayaran.php"><i class="fa fa-circle-o"></i> Input Pembayaran</a></li>			
  ...
  <div class="content-wrapper">
   ...
   <section class="content">
	...
	if(isset($_POST['simpan'])){
		...
		$query = "insert into pembayaran_ips values ('$nis','$pembayaran','$nama','$jenis_kelamin','$kelas','$tanggal')";
