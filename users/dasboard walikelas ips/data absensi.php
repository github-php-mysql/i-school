...
<?php
  require_once('../../koneksi.php');
	if(isset($_POST['simpan'])){
		...
		$qry = "insert into daftar_hadir_ips values ('','','$nis','','','$kehadiran')";
		unset($_POST['simpan']);
	}
?>
<html>
...
if (empty($cari)) {
  $qry = mysqli_query($conn, "SELECT * from kehadiran_ips ");
} else {
  $qry = mysqli_query($conn, "SELECT * from kehadiran_ips where nama like '%".$cari."%'");
}
...
?>
        <tr>
           <td><?php echo $no; ?></td>
						...
						<td><center>
							<a href="edit_absensi.php?nis=<?php echo $data['nis']; ?>"><span data-toggle="tooltip" title="Edit Absensi"><button class="btn btn-warning"><i class="fa fa-edit"></i></button>
								</a>
