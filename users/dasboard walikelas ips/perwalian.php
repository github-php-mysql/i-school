      ...
      <div class="row">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
				  ...
				  <td><a href="hapus chat.php?nip=<?php echo $data['nip']; ?>" onclick="return confirm('Apakah anda yakin menghapus data chat ini?')">
	   ...
	   <div class="box">
            ...
            <div class="box-body pad">
			  ...
			  <input type="hidden" name="wali_kelas_dari" value="<?php echo $data['wali_kelas_dari'];?>">
			  ...
			  <?php
									if (isset($_POST['kirim']))
									{
										$tanggal = date("Y-m-d");
										$nama = $_POST['nama'];
										$wali_kelas_dari = $_POST['wali_kelas_dari']; 
										$pesan = $_POST['pesan']; 
										$nip = $_POST['nip']; 
										
											$sql = "insert into perwalian_ips (date, keterangan, nama, kelas, nip) 
											values ('$tanggal', '$pesan', '$nama', '$wali_kelas_dari', '$nip')";
