      ...
      <ul class="sidebar-menu"><li class="treeview active">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
			...
			<li><a href="dasboard siswa ips/data nilai.php?nis=
			<?php 
				$nis = $data['nis'];
				$qry = mysqli_query ($conn, "select * from data_siswa_ips where nis = '$nis'");
			...
			<li><a href="dasboard siswa ips/data absensi.php"><i class="fa fa-circle-o"></i> Laporan Daftar Hadir</a></li>
			<li><a href="dasboard siswa ips/data pembayaran.php"><i class="fa fa-circle-o"></i> Laporan Data pembayaran</a>
		  </ul>
        </li>
    </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h1>Sistem Akademik</h1><br>
       ...
       <b>Unit Informasi Akademik</b> adalah suatu Sistem yang di bangun untuk mengelola data-data akademik sehingga memberikan kemudahan kepada pengguna dalam kegiatan akademik sekolah secara online</p>
        </div>
    </section>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="dasboard siswa ips/data absensi.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="dasboard siswa ips/data nilai.php?nis=
			<?php 
				$nis = $data['nis'];
				$qry = mysqli_query ($conn, "select * from data_siswa_ips where nis = '$nis'");
				if ($data2 = mysqli_fetch_array($qry)){
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="dasboard siswa ips/data pembayaran.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
