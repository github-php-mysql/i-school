      ...
      <ul class="sidebar-menu"><li class="active treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="dasboard orangtua ips/data nilai.php"><i class="fa fa-circle-o"></i>Nilai Siswa</a></li>
			<li><a href="dasboard orangtua ips/data absensi.php"><i class="fa fa-circle-o"></i>Daftar Hadir Siswa</a></li>
			<li><a href="dasboard orangtua ips/data pembayaran.php"><i class="fa fa-circle-o"></i>Pembayaran Siswa</a></li>
		  </ul>
        </li>
		<li class="treeview">
          <a href="dasboard orangtua ips/perwalian.php">
    ...
    <section class="content">
	  ...
	  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="dasboard orangtua ips/data nilai.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="dasboard orangtua ips/data absensi.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		...
		<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="dasboard orangtua ips/data pembayaran.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="dasboard orangtua ips/perwalian.php" class="small-box-footer">Lihat Info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
