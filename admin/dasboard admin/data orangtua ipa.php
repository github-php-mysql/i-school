  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="alert alert-dismissable alert-info">
			...
			<i class="fa fa-exclamation-circle"/></i>  Data-data orangtua, Untuk mencari nama siswa tinggal klik kolom pencarian. Tombol Ikon Kuning Untuk Mengedit, Tombol Ikon Merah Untuk Menghapus.
		</div>
		
        <div class="col-md-12 col-sm-4">
          <div class="panel panel-primary">
            <div class="panel-heading">Orang Tua IPA</div>
