	  ...
	  <div class="alert alert-dismissable alert-info">
        ...
        <div class="col-md-12 col-sm-4">
          <div class="panel panel-primary">
            <div class="panel-heading">WaliKelas IPS</div>
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
				<?php
					...
					if (empty($siswa)) {
						$qry = mysqli_query($conn, "SELECT * from walikelas_ips");
					}
						else {
					$qry = mysqli_query($conn, "SELECT * from walikelas_ips where nip like '");
					}
		...
		<td><?php echo $no; ?></td>
						...
						<td><center>
							<a href="ubah walikelas ips.php?nip=<?php echo $data['nip']; ?>"><span data-toggle="tooltip" title="Edit Akun"><button class="btn btn-warning"><i class="fa fa-edit"></i></button>
								</a>
							<a href="hapus walikelas ips.php?nip=<?php echo $data['nip']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')">
