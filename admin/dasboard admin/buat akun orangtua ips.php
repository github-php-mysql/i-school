      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="input orangtua.php"><i class="fa fa-circle-o"></i> Orang Tua</a></li>
		  </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <!--masukan kode disini-->
			...
			<i class="fa fa-exclamation-circle"/></i>Tambah Akun Orang Tua, insert text pada kolom lalu klik simpan, untuk menyimpan.</div>
      <div class="panel panel-sky col-xs-12 col-md-10 col-sm-6 col-lg-12">
					<div class="panel-heading">
						<h4>Buat Akun Orang Tua</h4>
					</div>
					<div class="panel-body collapse in">
						<form method="POST" class="form-horizontal row-border">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="password" value="<?php echo $data['password_orangtua']?>" class="form-control popovers" data-trigger="hover" data-toggle="popover" data-content="Masukkan Password">
								</div>
							</div>
							...
							<?php
								if(isset($_POST['simpan'])){
										$password = $_POST['password'];
											...
											$sql = "UPDATE data_siswa_ips SET password_orangtua='".$password."' where nis='".$nis."'";
											if (mysqli_query($conn, $sql)) 
										{
												echo "<script>alert('Data di simpan');document.location='input orangtua.php'</script>";
										} else{
