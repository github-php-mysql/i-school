  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <!--masukan kode disini-->
			...
			<a href="data walikelas.php"<span class='badge bg-blue'><span class='fa fa-external-link'></span> disini</span></a> untuk melihat data yang lain.
		</div>
	  
      <div class="panel panel-sky col-xs-12 col-md-5 col-sm-6 col-lg-12">
					<div class="panel-heading">
						<h4>Edit WaliKelas</h4>
					</div>
					<div class="panel-body collapse in">
						<form method="POST" class="form-horizontal row-border">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="number" name="nip" value="<?php echo $data['nip']?>" class="form-control popovers" data-trigger="hover" data-toggle="popover" data-content="Masukkan NIS">
					...
					<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="telepon"  value="<?php echo $data['kontak']?>" class="form-control">
								</div>
					</div>
						...
						<center>
							<?php
								if(isset($_POST['simpan'])){
									...
									{
											$sql = "UPDATE walikelas_ips SET nip='".$nip."', nama='".$nama."', jenis_kelamin='".$jenis_kelamin."', jabatan='".$jabatan."', wali_kelas_dari='".$kelas_dari."', kontak='".$no_tlpn."' where nip='".$nip."'";
