...
<head>
  ...
  <title>Input Akun Orang Tua</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="alert alert-dismissable alert-info">
			...
			<i class="fa fa-exclamation-circle"/></i> Data yang tertera otomatis terhubung dari nis siswa (anak)
		</div>
...
?>
		...
		<td><?php echo $data['username_orangtua']; ?></td>
		<td><?php echo $data['password_orangtua']; ?></td>
		<td><center>
							<a href="buat akun orangtua.php?nis=<?php echo $data['nis']; ?>"><span data-toggle="tooltip" title="Buat"><button class="btn btn-success"><i class="fa fa-edit"></i></button>
								</a>
						</td>
				</tr>
