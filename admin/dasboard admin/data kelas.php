      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="data kelas.php"><i class="fa fa-circle-o"></i> Data Kelas</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="alert alert-dismissable alert-info">
			...
			<i class="fa fa-exclamation-circle"/></i>  Data-data kelas, Untuk mencari nama siswa tinggal klik kolom pencarian. Tombol Ikon Kuning Untuk Mengedit, Tombol Ikon Merah Untuk Menghapus.
		</div>
		
        <div class="col-md-12 col-sm-4">
          <div class="panel panel-primary">
            <div class="panel-heading">Kelas IPA</div>
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
				<?php
					...
					if (empty($siswa)) {
						$qry = mysqli_query($conn, "SELECT * from kelas_ipa");
					}
						else {
					$qry = mysqli_query($conn, "SELECT * from kelas_ipa where kelas like '");
					}
        ...
        <tr>
		        ...
		        <div class="col-md-12 col-sm-4">
          <div class="panel panel-primary">
            <div class="panel-heading">Kelas IPS</div>
            <div class="box-body table-responsive">
			<div class="box-body no-padding">
      <table id="example1" class="table table-bordered table-striped">
				<thead>
        ...
        <tbody>
				<?php
					...
					if (empty($siswa)) {
						$qry = mysqli_query($conn, "SELECT * from kelas_ips");
					}
						else {
					$qry = mysqli_query($conn, "SELECT * from kelas_ips where kelas like '");
					}
