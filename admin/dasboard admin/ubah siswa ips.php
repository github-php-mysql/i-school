  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <!--masukan kode disini-->
			...
			<a href="siswa ips.php"<span class='badge bg-blue'><span class='fa fa-external-link'></span> disini</span></a> untuk melihat data yang lain.
		</div>
			...
			<?php
				if(isset($_POST['simpan'])){
						...
						$semester = $_POST['semester'];
							...
							if(!empty($nis) && !empty($nama) && !empty($id_kelas) && !empty($semester))
					{
							$sql = "UPDATE data_siswa_ips SET nis='".$nis."', kelas='".$id_kelas."', semester='".$semester."' where nis='".$nis."'";
