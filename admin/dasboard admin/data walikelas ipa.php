...
<head>
  ...
  <title>Laporan Data WaliKelas</title>
      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="data walikelas.php"><i class="fa fa-circle-o"></i>  Data Wali Kelas</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="alert alert-dismissable alert-info">
			...
			<i class="fa fa-exclamation-circle"/></i>  Data-data WaliKelas, Untuk mencari nama siswa tinggal klik kolom pencarian. Tombol Ikon Kuning Untuk Mengedit, Tombol Ikon Merah Untuk Menghapus.
		</div>
		
        <div class="col-md-12 col-sm-4">
          <div class="panel panel-primary">
            <div class="panel-heading">WaliKelas IPA</div>
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
				<?php
					...
					if (empty($siswa)) {
						$qry = mysqli_query($conn, "SELECT * from walikelas_ipa");
					}
						else {
					$qry = mysqli_query($conn, "SELECT * from walikelas_ipa where nip like '");
					}
		...
		<td><?php echo $no; ?></td>
                        ...
                        <td><?php echo $data['wali_kelas_dari']; ?></td>
						<td><?php echo $data['kontak']; ?></td>
						<td><center>
							<a href="ubah walikelas ipa.php?nip=<?php echo $data['nip']; ?>"><span data-toggle="tooltip" title="Edit Akun"><button class="btn btn-warning"><i class="fa fa-edit"></i></button>
								</a>
							<a href="hapus walikelas ipa.php?nip=<?php echo $data['nip']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')">
