...
<?php
    ...
    $qry = mysqli_query($conn, "SELECT * FROM orang_tua_ips	where username='$username'");
      ...
      <ul class="sidebar-menu"><li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="data orangtua.php"><i class="fa fa-circle-o"></i> Data Orang Tua</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <!--masukan kode disini-->
			...
			<a href="data orangtua.php"<span class='badge bg-blue'><span class='fa fa-external-link'></span> disini</span></a> untuk melihat data yang lain.
		</div>
	  
				<div class="panel panel-sky">
					<div class="panel-heading">
						<h4>Edit Data Orang Tua IPS</h4>
					</div>
					<div class="panel-body collapse in">
						<form method="post" class="form-horizontal row-border">
							<div class="form-group">
								<label class="col-sm-3 control-label">Nis Anak</label>
									<div class="col-sm-6">
											<select class="form-control" name="nis_anak">
												<?php
												$qry = mysqli_query($conn, "select nama, nis from data_siswa_ips");
					...
					<center>
								...
								if(isset($_POST['simpan'])){
										$nis= $_POST['nis_anak'];
										$nik= $_POST['nik'];
											$sql = "UPDATE orang_tua_ips SET orang_tua_dari='".$nis."', nik='".$nik."' where username='".$username."'";
