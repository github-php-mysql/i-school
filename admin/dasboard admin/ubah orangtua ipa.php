...
<?php
    ...
    $qry = mysqli_query($conn, "SELECT * FROM orang_tua_ipa where username='$username'");
				...
				<div class="panel panel-sky">
								...
								<label class="col-sm-3 control-label">Nis Anak</label>
									<div class="col-sm-6">
											<select class="form-control" name="nis_anak">
												<?php
												$qry = mysqli_query($conn, "select nama, nis from data_siswa_ipa");
					...
					<center>
								...
								if(isset($_POST['simpan'])){
										$nis= $_POST['nis_anak'];
										$nik= $_POST['nik'];
											$sql = "UPDATE orang_tua_ipa SET orang_tua_dari='".$nis."', nik='".$nik."' where username='".$username."'";
