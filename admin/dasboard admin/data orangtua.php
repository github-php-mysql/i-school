	  ...
	  <!--masukan kode disini-->
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Data Orang Tua <h3>IPA</h3></p>
            </div>
            <div class="icon">
              <i class="fa  fa-users"></i>
            </div>
            <a href="data orangtua ipa.php" class="small-box-footer">Tampilkan <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Data Orang Tua <h3>IPS</h3></p>
            </div>
            <div class="icon">
              <i class="fa  fa-users"></i>
            </div>
            <a href="data orangtua ips.php" class="small-box-footer">Tampilkan <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
