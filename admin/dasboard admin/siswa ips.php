...
?>
		...
		<td><center>
							<a href="ubah siswa ips.php?nis=<?php echo $data['nis']; ?>"><span data-toggle="tooltip" title="Edit Akun"><button class="btn btn-warning"><i class="fa fa-edit"></i></button>
								</a>
							<a href="hapus ips.php?nis=<?php echo $data['nis']; ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')">
