...
?>
		...
		<td><center>
							<a href="buat akun orangtua ips.php?nis=<?php echo $data['nis']; ?>"><span data-toggle="tooltip" title="Buat"><button class="btn btn-success"><i class="fa fa-edit"></i></button>
								</a>
						</td>
				</tr>
